...
public class ResultView extends ScreenAdapter {
    ...
    private Texture backgroundTexture, playAgainTexture, backTexture, volumeTexture, muteTexture, logoTexture;
    ...
    private void showAlert(String message) {
        ...
        dialog.getContentTable().pad(20).add(msg).width(stage.getViewport().getWorldWidth() * 0.8f).row();
